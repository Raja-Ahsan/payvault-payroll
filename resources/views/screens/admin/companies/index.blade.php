                ...
                <div class="card">
                    <div class="card-header card-no-border text-end">
                        <div class="card-header-right-icon">
                            <a class="btn btn-primary f-w-500" href="{{ route('companies.create') }}"><i
                            ...
                            <div class="table-responsive custom-scrollbar">
                                <table class="table" id="users-table">
                                    <thead>
                                        <tr>
                                            <th>
                                                <span class="c-o-light f-w-600">Company Name</span>
                                            </th>
                                            <th>
                                                <span class="c-o-light f-w-600">Company Type</span>
                                            </th>
                                            <th>
