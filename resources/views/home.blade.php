...
@section('content')
   <main >
    ...
    <section class="hero-section" 
             style="background-image: url('{{ asset('images/hero-bg-image.png') }}');">
...
<section class="py-10 md:py-20">
    <div class="container mx-auto px-4 md:px-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <!-- Left Content -->
            <div>
                <h2 class="text-[var(--text-secondary-color)] text-[32px] md:text-[48px] font-bold leading-tight mb-12 max-w-md">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-[#2D5A27] p-6 rounded-[20px]">
                        ...
                        <p class="text-[var(--text-color)] text-[18px] font-normal leading-relaxed">
                            Oversee multiple companies, manage payroll workflows, ensure compliance, and maintain complete audit trails — all from one dashboard.
                        </p>
                    </div>
                    ...
                    <div class="p-4">
                        ...
                        <p class="payroll-text">
                            Run payroll with confidence. Review, approve, and finalize payroll quickly without complexity or manual calculations.
                        </p>
                    </div>
                    ...
                    <div class="p-4">
                        ...
                        <p class="payroll-text">
                            Securely access payslips, payroll history, and payment details anytime through a simple, user-friendly portal.
                        </p>
                    </div>
                </div>
            ...
            <!-- Right Image -->
            <div class="relative">
                <img src="{{ asset('images/designed-payroll.png') }}" alt="Payroll Management Dashboard" class="w-full h-auto mt-10">
            </div>
    ...
    <div class="container mx-auto px-4 md:px-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 relative">
            ...
            <div class="text-center flex flex-col items-center">
                <div class="mb-6">
                    <img src="{{ asset('images/step-icon-01.png') }}" alt="Step 1" class="w-28 h-28 md:w-30 md:h-30 object-contain">
                </div>
            ...
            <div class="text-center flex flex-col items-center">
                <div class="mb-6">
                    <img src="{{ asset('images/step-icon-02.png') }}" alt="Step 2" class="w-28 h-28 md:w-30 md:h-30 object-contain">
                </div>
            ...
            <div class="text-center flex flex-col items-center">
                <div class="mb-6">
                    <img src="{{ asset('images/step-icon-03.png') }}" alt="Step 3" class="w-28 h-28 md:w-30 md:h-30 object-contain">
                </div>
            ...
            <div class="text-center flex flex-col items-center">
                <div class="mb-6">
                    <img src="{{ asset('images/step-icon-04.png') }}" alt="Step 4" class="w-28 h-28 md:w-30 md:h-30 object-contain">
                </div>
    ...
    <div class="security-box">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
            ...
            <div class="order-2 lg:order-1">
                <img src="{{ asset('images/first-left-image.png') }}" alt="Security Illustration" class="w-full max-w-xl mx-auto h-auto">
            </div>
            ...
            <div class="order-1 lg:order-2">
                ...
                <p class="security-text">
                    Payroll data is highly sensitive — and we treat it that way. Our platform is built using industry best practices to safeguard employee and financial information, ensuring secure access, complete transparency, and full accountability across every payroll action.
                </p>
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <a href="#" class="bg-[var(--bg-color)] text-[var(--text-secondary-color)] px-8 py-3 rounded-xl font-semibold hover:bg-gray-100 transition-all">Request a Demo</a>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <!-- Right Image -->
            <div>
                <img src="{{ asset('images/secomd-right-image.png') }}" alt="Payroll Dashboard Mockup" class="w-full h-auto">
            </div>
        </div>
    ...
    <div class="container mx-auto px-4 md:px-10">
        ...
        <div class="text-center mb-20 text-[var(--text-secondary-color)]">
            ...
            <p class="text-[18px] md:text-[20px] font-normal opacity-70 max-w-2xl mx-auto leading-relaxed">
                Choose the plan that fits your business. No hidden fees. <br class="hidden md:block"> No long-term contracts.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="pricing-card group">
                ...
                <div class="pricing-card-bottom">
                    <p class="font-bold text-[16px] mb-2 feature-text">Includes everything in DIY Payroll, plus:</p>
                    <ul class="space-y-4">
    ...
    <div class="mx-[10px]">
        <div class="simple-payroll">
            <div class="simple-payroll-content">
                ...
                <!-- Right Content -->
                <div class="order-1 lg:order-2">
                    <h2 class="text-[32px] md:text-[48px] font-bold text-[var(--text-secondary-color)] leading-tight mb-6">
                        Ready to Simplify <br class="hidden md:block"> Payroll Management?
                    </h2>
                    <p class="simple-payroll-text">
                        See how our platform can streamline payroll operations while maintaining security and compliance.
                    </p>
                    <div class="flex flex-wrap gap-4">
                        <a href="#" class="primary-btn">Request a Demo</a>
                        <a href="#" class="bg-[#D6E6CB] text-[var(--text-secondary-color)] px-8 py-3 rounded-xl font-semibold hover:bg-black/10 transition-all">Contact Our Team</a>
                    </div>
                </div>
            </div>
        </div>
