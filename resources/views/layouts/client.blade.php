            ...
            <div class="flex flex-col h-full">
                    ...
                    <ul class="space-y-2">
                        <li>
                            <a href="{{ route('client.dashboard') }}"
                                class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('client.dashboard') ? 'active-menu' : 'text-gray-700 hover:bg-gray-100' }}">
                        ...
                        <li>
                            <a href="{{ route('client.employees.index') }}"
                                class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('client.employees.*') ? 'active-menu' : 'text-gray-700 hover:bg-gray-100' }}">
                ...
                <div class="p-4 border-t">
                    ...
                    <form method="POST" action="{{ route('web.logout') }}">
                        @csrf
                        <button type="submit"
                            class="w-full flex items-center justify-center px-4 py-2 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition">
