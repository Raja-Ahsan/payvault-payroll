    ...
    <form action="{{ route('admin.payroll.update', $payroll) }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="md:col-span-2">
                ...
                <select name="company_id" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500" disabled>
        ...
        <div class="mt-6 flex items-center justify-end space-x-4">
            <a href="{{ route('admin.payroll.show', $payroll) }}" class="px-6 py-2 border rounded-lg text-gray-700 hover:bg-gray-50">
                Cancel
            </a>
