...
@section('page-description', 'Manage all payroll runs')

@section('content')
<div class="bg-white rounded-lg shadow-md p-6">
    <div class="flex items-center justify-between mb-6">
        <h3 class="text-xl font-semibold text-gray-800">All Payroll Runs</h3>
        <a href="{{ route('admin.payroll.create') }}" class="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-4 py-2 rounded-lg hover:from-purple-700 hover:to-indigo-700 transition">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex items-center space-x-2">
                            <a href="{{ route('admin.payroll.show', $payroll) }}" class="text-blue-600 hover:text-blue-900" title="View">
                                <i class="fas fa-eye"></i>
                            </a>
                            @if($payroll->status == 'draft')
                                <a href="{{ route('admin.payroll.edit', $payroll) }}" class="text-indigo-600 hover:text-indigo-900" title="Edit">
                ...
                <tr>
                    <td colspan="6" class="px-6 py-4 text-center text-gray-500">
                        No payroll runs found. <a href="{{ route('admin.payroll.create') }}" class="text-purple-600 hover:text-purple-800">Create one now</a>
                    </td>
                </tr>
                @endforelse
            </tbody>
